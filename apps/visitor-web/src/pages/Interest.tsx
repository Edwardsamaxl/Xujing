...
export default function Interest() {
  ...
  return (
    <div
      className={`flex min-h-screen flex-col px-5 pt-10 pb-8 bg-paper transition-all duration-500 ease-out ${
    ...
    >
      <div className="mx-auto w-full max-w-[400px]">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    borderColor: isSelected ? "rgba(163,38,38,0.45)" : "#A32626",
                    color: isSelected ? "rgba(163,38,38,0.65)" : "#A32626",
                  }}
                >
        ...
        {/* Selected preview */}
        {selected && (
          <div className="mb-6 p-4 rounded-lg bg-gold-dim border border-gold/10 animate-ink-bleed">
        ...
        <button
          onClick={handleStart}
          disabled={!selected}
          className="h-12 w-full rounded-full bg-cinnabar text-[15px] font-medium text-white tracking-[0.06em] transition-all duration-200 ease-out active:scale-[0.96] disabled:bg-ink-faint/20 disabled:text-ink-faint/40 disabled:active:scale-100 hover:shadow-[0_4px_16px_rgba(163,38,38,0.15)]"
